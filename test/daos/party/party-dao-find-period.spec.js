...
var periodQuery = {"to":"2020-12-12T06:00:00.000Z","from":"2019-11-12T02:30:23.325Z"};

describe.only("Testing party dao find methods", function() {
	[DataSourceHandler.MONGOOSE, DataSourceHandler.LOKIJS].forEach(function(dbEngine) {
		describe("Given the inserted records", function() {
			...
			describe("When calling findPeopleByPeriod", function() {
				it("The method should return 2 records", function(done) {
					partyDao.findPeopleByPeriod(periodQuery).then(function(result) {
						//let r = result.map((r) => r.dateCreated)
