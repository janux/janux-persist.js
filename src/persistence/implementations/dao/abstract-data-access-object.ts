 ...
 *
 *    Lokijs and mongodb assigns an unique id for every document. In lokijs the id is stored in a attribute called
 ...
 * daos, in a service.
 *
 * 10.. Also you can define an EntityProperties object. If defined, that abstract dao adds the following features.
 *
 * If EntityProperties.identifiable is true. Then the dao assigns a new attribute to the collection called uuid.
...
export abstract class AbstractDataAccessObject<t>  implements ICrudRepository<t> {
     ...
     */
    public saveOrUpdate(object: t): Promise<t | IValidationError[]> {
     ...
     * returns an empty array.
     */
    public findAllByQuery(query: any): Promise<t[]> {
